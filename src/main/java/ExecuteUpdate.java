...
public class ExecuteUpdate {
    public static void main(String[] args) throws SQLException {
       ...
       int updatedRows=statement.executeUpdate(query1);// executeUpdate() return int value which number of updated records
        ...
        //Add new developer to developers table
        String query3="INSERT INTO developers (id, name, salary,prog_lang) VALUES (21,'Bedrettin', 6000, 'Python')";
        ...
        System.out.println("deletedRows2 = " + deletedRows2);
